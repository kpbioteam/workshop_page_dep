...
<p><a target="_blank" rel="noopener noreferrer" href="Epigenetic_mechanisms.jpg"><img src="Epigenetic_mechanisms.jpg" alt="epimechanism" title="How epigenetics mechanism can effect health (adapted from https://commonfund.nih.gov/epigenomics/figure)" style="max-width:100%;"></a></p>
...
<p><a target="_blank" rel="noopener noreferrer" href="methylationassay.png"><img src="methylationassay.png" alt="methassay" title="Infinium Methylation Assay Overview (adapted from https://emea.illumina.com/science/technology/beadarray-technology/infinium-methylation-assay.html?langsel=/gb/)" style="max-width:100%;"></a></p>
<table>
<thead>
<tr>
<th>Accession</th>
...
<div class="tooltip">Tip: Importing data via links
...
<p>{: .hands_on}</p>
<p><a target="_blank" rel="noopener noreferrer" href="qcplot.png"><img src="qcplot.png" alt="Quality Control" title="Quality control plot" style="max-width:100%;"></a></p>
...
<p><a target="_blank" rel="noopener noreferrer" href="browser1.png"><img src="browser1.png" alt="UCSC table browser interface" style="max-width:100%;"></a></p>
</li>
<li>
...
<p><a target="_blank" rel="noopener noreferrer" href="browser2.png"><img src="browser2.png" alt="Output settings" style="max-width:100%;"></a></p>
</li>
<li>
...
<p><a target="_blank" rel="noopener noreferrer" href="ucsc.png"><img src="ucsc.png" alt="Display at UCSC" title="UCSC genome track showing differentialy methylated regions located on chromosome 6" style="max-width:100%;"></a></p>
<blockquote>
...
<p>{: .hands_on}</p>
<p><a target="_blank" rel="noopener noreferrer" href="funcann.jpg"><img src="funcann.jpg" alt="Functional annotations" title="Results of GO enrichments analysis for DMPs" style="max-width:100%;"></a></p>
<table>
<thead>
<tr>
<th>ID</th>
